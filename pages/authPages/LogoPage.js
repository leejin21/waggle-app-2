    ...
    return (
        <View style={{width:windowWidth, height:windowHeight, backgroundColor:Color.yellow, justifyContent:"center", alignItems:"center"}}>
            <TouchableOpacity onPress={() => props.navigation.navigate("Login")}>
                ...
                <Image style={{ width: size, height: size, zIndex: 1, position: "absolute", left: 77, top: 60,
                    shadowColor: "#000",
                    shadowOffset: {
                        width: 0,
                        height: 2,
                    ...
                    elevation: 5,
            }} source={require('../../constants/logo_yellow.png')}></Image>
            </TouchableOpacity>
        </View>
    );
};
...
const styles = StyleSheet.create({
    ...
    circle__small: {
        width: radius__small * 2, height: radius__small * 2, borderRadius: radius__small,
